...
> **Note:** The native TheHive-to-OpenCTI connector requires TheHive 5 and is incompatible with TheHive 4. Threat intelligence enrichment from OpenCTI is performed indirectly through Shuffle workflows rather than a direct connector.
