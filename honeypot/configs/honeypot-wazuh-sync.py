...
# ELK on haccp bare metal (migrated from pitcrew LXC 201, March 2026)
# NOTE: Honeypot sync decommissioned 2026-03-12. Script retained for reference.
ELK_HOST = os.environ.get("ELK_HOST", "https://10.10.30.25:9200")
