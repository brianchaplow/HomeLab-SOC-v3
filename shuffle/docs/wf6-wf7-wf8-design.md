...
| ~~WF7 — Honeypot Intel Report~~ | ~~Weekly (Sun)~~ | ~~1200~~ | ~~`0 17 * * 0`~~ | ~~Decommissioned March 2026 (honeypot campaign ended)~~ |
...
- ~~1200: WF7 (honeypot intel, decommissioned)~~
...
- New shared variables: `$elk_url` (https://10.10.30.25:9200 on haccp), `$elk_user`, `$elk_pass` for writing to ELK indices
